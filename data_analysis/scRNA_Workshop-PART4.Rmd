...
```{r jackstraw, eval=FALSE, warning=FALSE,error=FALSE,message=FALSE}
experiment.integrated <- JackStraw(object = experiment.integrated, dims = 100)
```

```{r plot_jackstraw, eval=FALSE, warning=FALSE,error=FALSE,message=FALSE, fig.width=10, fig.height=12, warning=FALSE}
