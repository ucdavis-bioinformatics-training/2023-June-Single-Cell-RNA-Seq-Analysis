...
```{r doubletfinder-bonus, eval=FALSE, warning=FALSE,error=FALSE,message=FALSE}
...
### Download Rmd file for Part 7

```{r download7, eval=TRUE, warning=FALSE,error=FALSE,message=FALSE}
